<template>
  <div class="article-container">
    ...
    <div class="main-wrap">
      ...
      <template>
        <!-- 加载完成-文章详情 -->
        <div class="article-detail" v-if="!is404Error">
          <!-- 文章标题 -->
          ...
          <van-cell class="user-info" center :border="false">
            ...
            <!-- <FollowUser v-model='article.is_followed'></FollowUser> -->
            <!-- <FollowUser
        ...
        <div class="error-wrap" v-else v-show="!!is404Error">
          <van-icon name="failure" />
    ...
    <!-- 底部区域 -->
    <div class="article-bottom" v-if="!isLoading && !is404Error">
      <van-button
        class="comment-btn"
        type="default"
        round
...
export default {
  ...
  methods: {
    async getArticle () {
      try {
        const res = await getArticleApi(this.article_id)
        console.log(res)
      ...
      this.$nextTick(() => {
        const arr = window.document.querySelectorAll('.article-content img')
